...
router.get('/setup-pmb', pmbFormController.getPmbForm);
router.get('/setup-pmb/:page', pmbFormController.getPmbForm);
router.post('/setup-pmb/form', pmbFormController.addPmbForm);
router.post('/setup-pmb/form/edit/:id', pmbFormController.editPmbForm);
router.get('/setup-pmb/form/:id', pmbFormController.deletePmbForm);
